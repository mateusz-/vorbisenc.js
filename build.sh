...
emcc --bind --js-library $dir/web-worker/web-worker-library.js -s TOTAL_MEMORY=134217728 -s EXPORTED_FUNCTIONS='["_vorbisenc_start", "_vorbisenc_write", "_vorbisenc_finish"]' -I $dir/vorbis/include -I $dir/ogg/include -L$dir/vorbis/lib/.libs -L$dir/ogg/src/.libs -lvorbis -lvorbisenc -logg $dir/web-worker/web-worker.cpp -o $dir/web-worker/web-worker.js 
